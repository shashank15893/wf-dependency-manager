...
Please use **setup-instructions.txt** from the repo to setup the application to run from local.
You can also **use setup-instructions-docker.md** to run the application on a docker.
